...
const sassRegex = /\.(sa|sc)ss$/;
const sassModuleRegex = /\.module\.(sa|sc)ss$/;
...
module.exports = function() {
  ...
  return {
    ...
    entry: [
      path.resolve(APP_SRC_PATH, 'demo/index.tsx'),
    ],
      ...
      rules: [
        { parser: { requireEnsure: false }},
        {
          oneOf: [
            ...
            // Opt-in support for Sass (using .sass or .scss extensions).
            // By default we support Sass Modules with the
            // extensions .module.sass or .module.scss
            {
              test: sassRegex,
            ...
            // using the extension .module.sass or .module.scss
            {
